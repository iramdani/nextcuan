...
if (startIndex !== -1 && endIndex !== -1) {
    ...
    let updatedFunc = `function renderSalesChart(periodDays) {
            ...
            cachedAdminOrdersForChart.forEach(order => {
                ...
                // Add to chart map even if period is all, and ensure map keys exist
                    ...
                    datasets: [
                        {
                            label: 'Lunas',
                            data: dataRevLunas,
                            orderCountData: dataCountLunas, // Custom property for tooltip
                            borderColor: '#10b981', // Emerald text-[#10b981]
                        ...
                        },
                        {
                            label: 'Pending',
                            data: dataRevPending,
                            orderCountData: dataCountPending, // Custom property for tooltip
                            borderColor: '#f59e0b', // Amber text-[#f59e0b]
                        ...
                        },
                        {
                            label: 'Batal',
                            data: dataRevBatal,
                            orderCountData: dataCountBatal, // Custom property for tooltip
                            borderColor: '#ef4444', // Red text-[#ef4444]
                        ...
                        tooltip: {
                            ...
                            callbacks: {
                                label: function(context) {
                                    ...
                                    let revStr = new Intl.NumberFormat('id-ID', { style: 'currency', currency: 'IDR', maximumSignificantDigits: 3 }).format(context.parsed.y);
                                    let countStr = context.dataset.orderCountData[context.dataIndex];
                                    
                                    // Returning an array creates a multi-line tooltip string per dataset!
                                    return [
                                        label + ' Pendapatan: ' + revStr,
                                        label + ' Pesanan: ' + countStr
                                    ];
                                }
                            }
                        }
